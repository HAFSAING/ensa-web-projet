...
// Nettoyer la variable de session après l'affichage de la page
    ...
    <div class="main-wrapper">
        <div class="confirmation-container">
            ...
            <div class="next-steps">
                ...
                <ol>
                    <li>Notre équipe vérifiera vos informations professionnelles auprès de l'Ordre National des Médecins.</li>
            ...
            <a href="docConnecter.php" class="btn">Retour à la page de connexion</a>
        </div>
    </div>
